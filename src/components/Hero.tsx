...
import heroImage from "@/images/bag-1.webp";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-foreground">
              Bolsas exclusivas
              <span className="block text-luxury mt-2">
                que combinam com Você
              </span>
            </h1>
            <p className="text-lg md:text-xl text-foreground/80 max-w-xl mx-auto lg:mx-0">
              Descubra nossa coleção de bolsas refinadas, onde luxo e elegância
              se encontram. Cada peça é selecionada com cuidado para realçar seu
              estilo único.
            </p>
